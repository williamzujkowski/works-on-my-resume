 ...
 * the ThemePicker badges share a single source.
 *
 * AAA ≥ 7:1, AA ≥ 4.5:1, otherwise fails AA. The thresholds match what
 * `ThemePicker.tsx` uses today; that file keeps its own private copy for now,
 * but any new caller should import from here.
 */
